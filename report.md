...
```
s=2.52631578947;// начальное расстояние от лодки до катера
fi=3*%pi/4;
...
![траектории для случая 1](images/01.PNG){ #fig:001 width=70% height=70% }
...
![траектории для случая 2](images/02.PNG){ #fig:002 width=70% height=70% }
